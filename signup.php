...
<?php
session_start();
// $conn = mysqli_connect('localhost','id20384284_didcafe','Shahd@982003','id20384284_db1') or die('connection failed');
...
<body>
   ...
   <br>
      ...
      <input type="password" name="password" required id="txtPassword" placeholder=" Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" >
  <button type="button" id="btnToggle" class="toggle"><i id="eyeIcon" class="fa fa-eye"></i></button>
        
      <input type="password" name="cpassword" required placeholder=" Confirm Password"  id="txtPassword2"  >
      <button type="button" id="btnToggle2" class="toggle2"><i id="eyeIcon2" class="fa fa-eye"></i></button>
...
<br>
      <p>If You Have Alredy an Account <a href="log.php">Click Here</a></p>
        ...
        <script>
        let passwordInput = document.getElementById('txtPassword'),toggle = document.getElementById('btnToggle'), icon =  document.getElementById('eyeIcon');
...
let passwordInput2 = document.getElementById('txtPassword2'),toggle2 = document.getElementById('btnToggle2'),
   ...
   if(mysqli_num_rows($result) > 0){
    ...
    echo '<script>alert("Email Alredy Exists");</script>';
      ...
      if($pass != $cpass)
      {
        ...
        $insert=mysqli_query($conn, "INSERT INTO `formtest` SET uname = '$name',image = '$fName', email = '$email', phone='$number',pass = '$pass'" );

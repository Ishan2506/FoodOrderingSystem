...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image,cat,p_quantity) VALUES('$p_name', '$p_price', '$p_image','$cat','$quantity')") or die('query failed');
...
<!--  
  <input type="radio" id="html" name="cat" value="pizza">Pizza

 <input type="radio" id="css" name="cat" value="burger">Burger

 <input type="radio" id="css" name="cat" value="cake">cake

 <input type="radio" id="css" name="cat" value="coffee">coffee

 <input type="radio" id="css" name="cat" value="drink">Drink -->
 ...
 <select name="cat"  class="box" >
  ...
  <!--<input type="number" name="quantity" class="box" placeholder="Enter Quantity Of Food" required>-->
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" class="box"  name="update_p_image" accept="image/png, image/jpg, image/jpeg" require>
  <!--<input type="number" name="update_p_quantity" class="box" placeholder="Update Quantity Of Food"  value="<?php echo $fetch_edit['p_quantity']; ?>">-->
